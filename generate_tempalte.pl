...
$output_path= "/media/biswal/HENRY/DATA/OPTOGENETICS/sorted_opto_r/create_template_run02";
chdir "$output_path";
...
####---------- step 1 linear transformation
  #`3dAllineate -source $sub -base $reference -prefix allineate_$sub  -twopass -cost lpa -1Dmatrix_save allineate_$sub.tmp.aff12.1D -autoweight -cmass`;
